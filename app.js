window.onload = function () {
    ...
    htmlEditor.session.on('change', function (_delta) {
    ...
    cssEditor.session.on('change', function (_delta) {
    ...
    jsEditor.session.setValue("//js code goes here");
    jsEditor.session.setUseWrapMode(true);
    jsEditor.setShowPrintMargin(false);
    jsEditor.setHighlightActiveLine(false);
    jsEditor.session.on('change', function (_delta) {
